...
public class BookStore extends ApiUtilities {
    ...
    public Object deleteBook(IsbnUserModel book) {
        log.new Info("Deleting selected books to context user");
        Call<Object> bookCall = bookStoreAuthorized.deleteBook(book);
        return perform(bookCall, true, true);
    }
